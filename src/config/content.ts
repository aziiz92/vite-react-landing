...
export const content = {
  hero: {
    ...
    subheadline:
      "A clean baseline for landing pages: small components, config-driven content, subtle motion, and an optional 3D ornament that never blocks first paint.",
    primaryCta: { label: "Jump to next steps", href: "#cta" },
  ...
  socialProof: {
    ...
    note: "Replace these with your project/client names — or disable the section.",
  ...
  features: {
    ...
    description:
      "This repo is intentionally small: a handful of reusable sections driven by two config files.",
    items: [
      {
      ...
      {
        title: "Section toggles + reorderable layout",
        description:
          "Each section has an `enabled` flag, so you can remove or rearrange without rebuilding a design system.",
      },
      {
  ...
  howItWorks: {
    ...
    description:
      "Update the config, swap the copy, and ship. Keep the structure predictable so you can focus on visuals and message.",
    steps: [
      {
        title: "Set the site",
        description:
          "Update name, links, theme colors, and meta in `src/config/site.ts` (or run `npm run init`).",
      },
      {
        title: "Swap the copy",
        description:
          "Edit `src/config/content.ts` (features, steps, FAQ, testimonials, etc.). Keep it honest and editable.",
      },
      {
  ...
  testimonials: {
    ...
    description:
      "These are placeholders to show layout and rhythm — swap with real quotes or disable the section.",
    items: [
      {
        quote:
    ...
    items: [
      {
        ...
        answer:
          "Edit `src/config/site.ts`. It controls name, links, brand colors/gradients/fonts, and SEO defaults (and you can regenerate via `npm run init`).",
      },
      {
        question: "Does it support reduced motion?",
        answer:
          "Yes. Motion respects user settings, and the 3D ornament can disable when `prefers-reduced-motion` is enabled.",
      },
      {
        question: "Is the 3D required?",
        answer:
          "No. It’s lazy-loaded, deferred, and has a static fallback. You can also disable it in `src/config/site.ts`.",
      },
      {
  ...
  cta: {
    ...
    title: "Make it yours",
    description:
      "Run the init script, edit the two config files, then replace assets (favicon/OG image) when you’re ready.",
    primaryCta: {
      label: "Use this template",
      href: "https://github.com/your-handle/vite-react-landing/generate",
    },
    secondaryCta: { label: "View the repo", href: "https://github.com/your-handle/vite-react-landing" },
  },
  ...
  patterns: {
    ...
    description:
      "These are starter blocks. Swap the copy, reorder the page, and delete what you don’t need.",
    items: [
      {
        title: "Hero + optional 3D ornament",
        description: "Headline, subheadline, CTAs, and a visual that won’t block first paint.",
        bullets: [
          "Edit hero copy in `src/config/content.ts`",
          "Disable 3D with `site.features.enable3dHero`",
        ],
        highlighted: true,
      },
      {
        ...
        bullets: ["Update `content.features.items[]`", "Swap icons/illustrations as needed"],
      },
      {
        title: "FAQ + CTA",
